      ...
      {filteredList.map((data: IBike) => {
        ...
        return (
          ...
          >
            ...
            >
              <CardHeading className="bikesList--card__link--model">
                {data.model}
              </CardHeading>
              <CardSpan className="bikesList--card__link--color">
                {data.color}
              </CardSpan>
              <CardSpan className="bikesList--card__link--location">
                {data.location}
              </CardSpan>
              <CardRating
                className={`bikesList--card__link--rating rating${Math.floor(
                  data.rateAverage
                )}`}
              >
                {data.rateAverage}
              ...
              <CardAvailability
                className={data.isAvailable ? "" : "unavailable"}
              >
                {data.isAvailable ? (
                  <>

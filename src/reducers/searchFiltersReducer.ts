...
const searchFiltersReducer = (
    ...
    const { SHOW_USERS_WITH_RESERVATIONS, BIKE_RATING } = SEARCH_FILTERS_REDUCER_OPTIONS
    switch (action.type) {
        case SHOW_USERS_WITH_RESERVATIONS:
            return { ...searchFilters, showUserWithReservation: action.payload.showUserWithReservation }
